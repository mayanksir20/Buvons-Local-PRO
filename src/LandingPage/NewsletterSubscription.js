    ...
    return (
        <>
            <div className="body" ref={ref1}>
                ...
                <div className="mainBox" onClick={handleClose}>
                    <div className="BannerImg">
                        <img src={privacy_policy_bg} alt="HomeGiF" loading="lazy" />
                    </div>
                    <div className="container-fluid alignPadding h-100">
                        <div className="col-auto addProductBox">
                            <h2 className="subHeading text-uppercase text-white">Newsletter subscription</h2>
                            <div className="contentBx">
                                <div className="formBox  rounded-3  col-12 col-lg-12 mb-3 mt-4">
                                    <h4 class="formHeading">Keep up-to-date on news and promotions </h4>
                                    <form>
                                        <div className="mb-4 col-lg-7">
                                            <label className="form-label " for="emailSuscribe">ENTER EMAIL ADDRESS : </label>
                                            <input type="email" className="form-control" placeholder="Enter e-mail address" id="emailSuscribe" />
                                        </div>
                                        <div className="mb-4">
                                            <label className="form-label ">Please confirm that you are over the age of 18. </label>
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" value="" id="AgeValidation" />
                                                <label className="form-check-label" for="AgeValidation">
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <p>Buvons Local PRO will use the information you provide on this form to be in touch with you and to provide updates and marketing.</p>
                                            <div className="form-check">
                                                <input className="form-check-input" type="checkbox" value="" id="AgreePoint" />
                                                <label className="form-check-label" for="AgreePoint">I agree to receive electronic messages from Buvons Local PRO containing information and offers with respect to products that may be of interest to me, including notification of sales, special events and third-party promotions. I may withdraw this consent at any time by selecting the unsubscribe option. </label>
                                            </div>
                                        </div>
                                        <div className="col-4 pt-4 btnBox">
                                            <button class="btn btn-purpal btn-lg rounded-3 w-100" type="submit">SUBSCRIBE</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
