                ...
                <div className="mainBox" onClick={handleClose}>
                    ...
                    <div className="container-fluid alignPadding h-100">
                        <div className="col-xl-12 col-lg-12 col-md-12">
                            <h2 className="subHeading text-uppercase text-white">Debit Credit Application</h2>
                            <div class="col-auto mt-5 addProductBox">
                                <div class="card h-100 py-5">
                                    <a class="card-body" href={creditDebitApplication} download>
                                        <span class="addBtn downLoadIcon">
                                        <i><img src={downArrow}/></i>Download Application
                                        </span>
                                    </a>
                                </div>
                            </div>
...
export default DebitCreditApplication;