                    ...
                    <div className="container-fluid page-content-box px-3 px-sm-4">
                        <div class="row">
                            <div class="col-12 mb-3">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row">
                                            <div class="col-sm-8 col-12">
                                                    ...
                                                    <div class="mb-3">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <label className="form-label">Order Default Note*</label>
                                                            {/* <div class="form-check form-switch d-flex align-items-center">
                                                                <label class="form-check-label" for="flexSwitchCheck2">En</label>
                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheck2"/>
                                                                <label class="form-check-label" for="flexSwitchCheck2">Fr</label>
                                            ...
                                            <div class="col-sm-8 col-12"> 
                                                    ...
                                                    <div className="mt-4"> 
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label" for="MaximumOrder">Minimum Order Count per Order</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div> 
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label" for="MaximumOrder">Minimum Order Value per Order</label>
                                                        </div>
                                                    </div>                                                  
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div className="flex">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox1">Accepted Payment Type</label>
                                            </div>
                                            {payment ? <div class="d-flex mt-3">
                                                <div id="payment-box">
                                                <label className="form-label">For offline payment</label>
                                                ...
                                                <div id="payment-box">
                                                <label className="form-label">For online payment</label>
                                ...
                                <div class="d-flex">
                                    <button type="button" class="btn btn-outline-black width-auto me-2" onClick={() => navigate('/supplier/groups-management')}>Cancel</button>
