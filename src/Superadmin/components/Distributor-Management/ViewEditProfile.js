...
const ViewEditDistributorProfile = () => {
  ...
  const handleNext = (e) => {
    ...
    if (
      ...
      apis
        .post(`/updateDistributorUser/${user_id}`, formdata, config)
        .then((res) => {
    ...
    <div class="container-fluid page-wrap add-supplier">
      <div class="row height-inherit">
        ...
        <div class="col main p-0">
          <Header
            title={t("admin.distributor_management.edit_first.title")}
                ...
                <form>
                                ...
                                <div className="col text-center d-flex flex-column justify-content-center align-items-center">
                                  ...
                                  <div className="w-100 text-center">
                                    <div class="form-check form-switch d-inline-flex align-items-center w-auto">
                                      ...
                                      >
                                        {t(
                                          "admin.distributor_management.edit_first.enable"
                                        )}
                                      </label>
                                    </div>
                                  </div>
                            ...
                            <div className="card-body">
                              ...
                              <div className="row">
                                ...
                                <div className="col-sm-6 mb-3">
                                  <label className="form-label">
                                    {t(
                                      "admin.distributor_management.edit_first.mobile_number"
                                    )}
                                    <sup>*</sup>
                                  </label>
                                  <input
                              ...
                              {/* <div className="row">
                                <div className="col-sm-6 mb-3 ">
                                  ...
                                  <div className="position-relative">
                                    ...
                                    />
                                    <span className={showPass1 ? "form-field-icon icon-toggle active" : "form-field-icon icon-toggle"} onClick={() => setShowPass1(!showPass1)} style={pass2Error !== "" || pass1Error !== "" ? { bottom: "42px" } : {}}></span>
                                    {pass1Error !== "" ? <p className="error-label">{pass1Error}</p> : <></>}
                                  </div>
                                </div>
                                <div className="col-sm-6 mb-3 position-relative">
                                  ...
                                  <div className="position-relative">
                                    ...
                                    />
                                    <span className={showPass2 ? "form-field-icon icon-toggle active" : "form-field-icon icon-toggle"} onClick={() => setShowPass2(!showPass2)} style={pass2Error !== "" || pass1Error !== "" ? { bottom: "42px" } : {}}></span>
                                    {pass2Error !== "" ? <p className="error-label">{pass2Error}</p> : <></>}
                                  </div>
                                </div>
                              </div> */}
                            </div>
                  ...
                  <div className="row mt-4">
                    <div className="col">
                      ...
                      >
                        {t(
                          "admin.distributor_management.edit_first.cancel_button"
                        )}
                      </button>
                      <button
                      ...
                      >
                        {t(
                          "admin.distributor_management.edit_first.next_button"
                        )}
                      </button>
                    </div>
                  </div>
...
export default ViewEditDistributorProfile;
